...
| `EVID-EVENTS-QA`            | [Events design QA](../../../apps/mobile/evidence/events-option-2/design-qa.md)                                                                 | Visual, interaction, duplicate-title identity, offline, and accessibility review                          |
...
| `EVID-AUTH-QA`             | [Auth design QA](../../../apps/mobile/evidence/auth-option-2/design-qa.md)                                                               | State-machine preservation, recovery semantics, privacy, contrast, text scaling, and final pass       |
...
entry. They prove rendered queued, conflict, read-only and large-text states;
they do **not** claim a deployed backend, Android visual parity, or a real
service-backed disconnect/reconnect device journey. Those runtime/platform
boundaries remain under `crew-paq.7.4`.
...
| `EVID-TEAM-QA`                  | [Team design QA](../../../apps/mobile/evidence/team-collaboration-option-2/design-qa.md)                                                                      | Delivery-truth correction, interaction/A11y evidence, remaining P3 notes, final pass                                                              |
...
| `EVID-TEAM-PRODUCTION-QA`       | [Production Team design QA](../../../apps/mobile/evidence/team-production-routes/design-qa.md)                                                                | Native iPhone 16e render, stable-ID move, missing-name fallback, role/action semantics, and final pass                                            |
...
state, and a passing iOS Maestro accessibility path. It does **not** prove
Android Team-route rendering, generic conflict resolution, every
`ST-SCR-032/033` state, or a real service-backed disconnect/reconnect journey.
Those remain `DESIGN-REQUIRED` or pending vertical evidence as labelled in
[Flows and annotations](./03-flows-and-annotations.md).
...
their own same-state runtime captures before Android visual parity is claimed.
...
| Auth / invite / recovery | [SignInScreen.tsx](../../../apps/mobile/src/screens/SignInScreen.tsx), [InvitePreviewScreen.tsx](../../../apps/mobile/src/screens/InvitePreviewScreen.tsx), [InboundGateScreen.tsx](../../../apps/mobile/src/screens/InboundGateScreen.tsx)                                                                                | Auth, invite, pending-route, account-mismatch, denial, retry, and large-text focused suites                                                                                                                                                                                                                                                                                              |
