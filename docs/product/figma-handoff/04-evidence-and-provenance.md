...
or an updated external Figma file. Native Zurich DST-overlap round-trip
acceptance is NO-GO with the current nondeterministic fold picker harness. iOS
Share Sheet dismissal is not final because no green sanitized dismissal
...
## Plan, Live Item, and editor native evidence

| Evidence ID                           | Persistent file                                    | State and proof boundary                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------- | -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `EVID-PLAN-EDITOR-LIVE-NATIVE-202607` | `apps/mobile/evidence/plan-editor-live-2026-07-27` | Historical iOS-simulator and Android-emulator Plan, Live Item, action-area, and Plan Item Editor layouts retain their original source/runtime provenance; historical Android queued/conflict/tombstone covers font scales 1.0/2.0. The accepted current-source iOS matrix adds 21 unique queued/conflict/tombstone screenshots and 12 green sanitized reports across Editor, Plan, and Live at medium/Accessibility Extra Large, bound by `runtime/oracles/ios-current-state-matrix.json`. |

The packet binds every retained historical screenshot and report to its
recorded source and runtime without rebinding it to current source. The current
iOS oracle binds the accepted product, regression-test, harness, report and
runtime artifacts by content hash. Its Default-size conflict Editor frame
predates the final AXL-only StatusChip v3 refresh and is accepted
source-equivalent state evidence at font scale 1, not exact final-refresh
bundle-timing evidence. This is native simulator execution evidence, not a new
Option-2 visual approval or same-input design comparison. It does not claim
distribution signing, physical devices, VoiceOver/TalkBack traversal,
production, an updated external Figma file, or unpictured
`ST-SCR-010/011/014` variants.
...
state, and a passing iOS Maestro accessibility path. The later
`team-vertical-session-2026-07-27-final` packet
...
## Feedback compose and list native evidence

| Evidence ID                        | Persistent file                                        | State and proof boundary                                                                                                                                                                                                    |
| ---------------------------------- | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `EVID-FEEDBACK-TEAM-NATIVE-202607` | `apps/mobile/evidence/feedback-team-native-2026-07-27` | iOS-simulator and Android-emulator screenshot capture, consent-off preview, delivery, cold-restart server-backed list readback, and logout purge; the iOS extension also proves a real storage-denial to text-only recovery |

This packet covers `SCR-060` and the resulting `SCR-062` list readback. It does
not exercise `SCR-061` vote/comment/follow or owner/organizer triage, and it is
not a new Option-2 visual approval or same-input comparison. Distribution-signed
physical devices, VoiceOver/TalkBack, production, and an updated external Figma
file remain unproven.
...
claimed. The `team-vertical-session-2026-07-27-final` packet's Android
execution captures do not replace that comparison.
...
| Plan and Live            | [PlanScreen.tsx](../../../apps/mobile/src/screens/PlanScreen.tsx), [PlanRuntime.ts](../../../apps/mobile/src/screens/PlanRuntime.ts), [LiveItemScreen.tsx](../../../apps/mobile/src/screens/LiveItemScreen.tsx)                                                                                                                                                                                                     | [PlanRuntime.test.ts](../../../apps/mobile/__tests__/PlanRuntime.test.ts), [PlanViews.test.tsx](../../../apps/mobile/__tests__/PlanViews.test.tsx), [LiveItemScreen.test.ts](../../../apps/mobile/__tests__/LiveItemScreen.test.ts); child-event and itinerary authoring/reorder are code/test current. The native packet above preserves historical iOS/Android evidence and retains an accepted content-addressed current-source iOS queued/conflict/tombstone matrix across Editor, Plan, and Live at medium/Accessibility Extra Large. Distribution-signed physical-device, VoiceOver/TalkBack, production, external Figma, and uncaptured-state evidence remain pending.                                                                                                               |
...
| Auth / invite / recovery | [SignInScreen.tsx](../../../apps/mobile/src/screens/SignInScreen.tsx), [InviteManagerScreen.tsx](../../../apps/mobile/src/screens/InviteManagerScreen.tsx), [InviteEditorScreen.tsx](../../../apps/mobile/src/screens/InviteEditorScreen.tsx), [InvitePreviewScreen.tsx](../../../apps/mobile/src/screens/InvitePreviewScreen.tsx), [InboundGateScreen.tsx](../../../apps/mobile/src/screens/InboundGateScreen.tsx) | [InviteScreens.test.tsx](../../../apps/mobile/__tests__/InviteScreens.test.tsx) plus auth, pending-route, account-mismatch, denial, retry, pagination, permission concealment, stable replay, offline draft, token non-persistence, native-share retry, and large-text focused suites. The native iOS/Android picker and 7/7 simulator/emulator evidence above are current. Native Zurich DST-overlap round trip is NO-GO with the current nondeterministic fold picker harness; iOS Share Sheet dismissal has no final retained artifact. Physical distribution-signed 200% text, VoiceOver/TalkBack, and external Figma remain pending.                                                                                                                               |
