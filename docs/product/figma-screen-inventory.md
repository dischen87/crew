...
| Field                 | Specification                                                                                                                |
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| Route / purpose       | Current inline text/single-photo composer in `TeamFeed`; full-screen `FeedComposer({rootEventId,eventId?,entryId?})` remains the caption/edit/item-target contract |
