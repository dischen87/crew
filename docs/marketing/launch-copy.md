...
Zuletzt extern verifizierter Belegstand vor diesem Änderungssatz: `5be3026`;
...
`https://crew-haus.com/` live, ihr CTA bleibt ohne datenschutzgeprüften
Kontaktweg deaktiviert. Das
...
Evidence-Commit `262dd67`. Es ist kein Produktions-, Store-, physischer
Device-, Distributionssignatur-, Android-App-Link-, Privacy-/Legal-,
Provider-, Analytics- oder allgemeiner Launch-Beleg.
...
| `[P-MOBILE]`     | Lokale iOS-/Android-Release-Builds und fail-closed Runtime-Konfiguration sind belegt. Das finale lokale Team-/Feedback-Paket bindet einen iOS-Simulator und Android-API-36-Emulator an denselben Team-Root; Staging `5be3026` ist separat live. Nicht belegt sind ein distribution-signierter Native-to-Staging-Trace, physische Geräte, vollständige Accessibility, Android App Links, Stores oder Produktion. Erst danach veröffentlichen.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `[P-TEAM]`       | Autoritative Team-Flows und die produktiv gerouteten Design-2-Flächen `SCR-032/033` sind code-/test-current. Das finale lokale Team-/Feedback-Paket belegt eine kohärente iOS-Owner- und Android-Participant-Journey mit Plan, Live, Editor, Teamzuständen, Offline-Feed, Relaunch, verlorener Erfolgsantwort, identischem Replay, Konvergenz und Owner-Readback; 21/21 Flows sind grün und `crew-paq.8.3` ist geschlossen. Feature-Copy bleibt bis zu physischen Geräten, Distributionssignatur, vollständiger Accessibility, Native-to-Staging-E2E, Stores und Produktion gesperrt.                                                                                                                                                                                                                                                                                                                                                                                                              |
| `[P-ENRICHMENT]` | Budgetierter asynchroner Worker sowie Select-, Status- und Retry-Verträge sind in Backend, Gateway und generiertem Mobile-Client implementiert. Der native Zero-result-Review-Flow ist code- und test-current: erst nach einem leeren lokalen Suchergebnis, länderbegrenzt, mit höchstens drei automatischen Statusabfragen, sichtbaren Quellen, explizitem Freigeben/Ablehnen und sicherem Verbinden über den bestehenden Ortspfad. Feature-Copy bleibt bis zu deploytem und überwachtem Provider-Betrieb, Produktion sowie Offline-/Device-E2E gesperrt.                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `[P-FEEDBACK]`   | Backend, Gateway, Mobile-Client, SQLite und die produktiv gerouteten Design-2-Flows sind implementiert; Diagnose- und Screenshot-Consent sind getrennt und standardmässig aus. Aktive Owner und Organizer können den Status online ändern oder eine Meldung mit einem bereinigten Same-root-Ziel zusammenführen; Rollen-, Root-, Idempotency- und Safe-refresh-Pfade sind code- und test-current. Das finale lokale Team-/Feedback-Paket belegt den Android-Feedbackpfad mit Capture, Preview, Consent off, dauerhafter Queue, genau einer Attachment-Zustellung, Server-Readback nach Cold Restart und Logout-Purge. Community-Writes bleiben online-only. Feature-Copy bleibt bis zu physischen Geräten, Distributionssignatur, vollständiger Accessibility, HEIC-/Failure-Matrix, Native-to-Staging-E2E, Stores und Produktion gesperrt.                                                                                                                                                        |
...
| `[P-RELEASE]`    | Exact-SHA Staging `5be3026` und die öffentliche `noindex` Closed Preview sind live; CI und Staging-Release sind grün. Native Evidence bleibt lokal und Android nur debug-key-signiert. Erst nach Crew-eigener Distributionssignatur, physischen Geräten, Android App Links, authentifiziertem Native-to-Staging-/Produktions-Smoke sowie Store-, Privacy-/Legal- und Operations-Freigabe veröffentlichen.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
**Verifizierter Stand 2026-07-27:** `apps/web` ist unter
`https://crew-haus.com/` als öffentliche, script-freie Option-2-Closed-Preview
in `de-CH` live. Der statische Build emittiert nur die Preview-Seite; der alte
Join-Pfad liefert `404`. Die Route bleibt `noindex`, und ohne konfigurierte
absolute HTTPS-Kontaktadresse ist der CTA bewusst deaktiviert. Browser-renderte
Mobile-/Desktop-, Fokus-, Reduced-Motion- und 200%-Zoom-QA ist lokal bestanden.
Ein datenschutzgeprüfter Kontaktweg und eine Analytics-/Consent-Entscheidung
fehlen weiterhin. Diese Veröffentlichung ist **nur eine öffentliche Closed
Preview**, kein allgemeiner Produktlaunch, und belegt weder Anfragen,
Preview-Conversion noch Analytics.
