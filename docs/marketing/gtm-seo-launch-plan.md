...
Zuletzt extern verifizierter Release-Belegstand vor diesem Änderungssatz,
27. Juli 2026: `5be3026`;
[CI 30306944409](https://github.com/dischen87/crew/actions/runs/30306944409)
und [Staging-Release 30307216165](https://github.com/dischen87/crew/actions/runs/30307216165)
sind grün. Die öffentliche `noindex` Closed Preview ist unter
`https://crew-haus.com/` mit deaktiviertem CTA live. Das
[finale lokale Team-/Feedback-Paket](../../apps/mobile/evidence/team-vertical-session-2026-07-27-final/README.md)
belegt 21/21 Simulator-/Emulator-Flows für Source `75a6761` in
Evidence-Commit `262dd67`. Produktion, Stores, Distributionssignatur,
physische Geräte, Android App Links, Privacy-/Legal-Freigabe,
Provider-Aktivierung, Kontaktweg, Analytics und allgemeiner Launch bleiben
unbelegt.
...
| Native iOS-/Android-Experience                                                                                     | **Lokale Release-Runtime-Builds und kohärente Simulator-/Emulator-Experience Current; Release `[P-RELEASE]`**                                                          | Das finale lokale Team-/Feedback-Paket bindet einen iOS-Simulator und Android-API-36-Emulator an denselben Team-Root; exact-SHA Staging ist separat live. Android-Evidence ist lokal debug-key-signiert, nicht distribution-signiert. Keine kundengerichtete Verfügbarkeit vor physischer Device-/Accessibility-Evidence, Android App Links, authentifiziertem Native-to-Staging-Trace, Crew-eigener Signatur, Stores und Produktionsfreigabe.                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Team-Zuteilungen und Entscheidungen                                                                                | **Backend/Gateway/SQLite + produktive native Design-2-Routen und lokale Experience Current; Release `[P-TEAM]`**                                                       | Das finale lokale Team-/Feedback-Paket belegt eine kohärente iOS-Owner-/Android-Participant-Journey mit Plan, Live, Editor, Teamzuständen, Offline-Feed, Relaunch, verlorener Erfolgsantwort, identischem Replay, Konvergenz und Owner-Readback. 21/21 Flows sind grün; `crew-paq.8.3` ist geschlossen. Keine Acquisition-Copy vor physischer Device-, vollständiger Accessibility-, Distributions-, Native-to-Staging-, Store- und Produktionsabnahme.                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Autorisierungsgebundener Recap- und Share-Link-Lifecycle                                                           | **Title-only und exact-field Backend/Gateway/Mobile-Client/SQLite, 90-Tage-Metadaten-Retention sowie Design-2-Consent-UX Engineering-Current; Experience `[P-RECAP]`** | Engineering-Proof darf immutable Generation, Quell-/Membership-Revalidierung, Offline-Cache, manager-only sieben-Tage-Links sowie exact-version Body- und Caption-Text-Grants benennen. Caption-Refs sind frei von internen IDs, opaque und nur für die Sitzung verfügbar; Medienmetadaten enthalten sie nicht. Caption-Text ist server-default-off. Die [isolierte iOS-Release-shaped Design-2-Matrix](../../apps/mobile/evidence/recap-consent-option-2/README.md) belegt Body-Rollen/Grant/Withdrawal/Drift mit Fixtures, nicht Caption-Device oder Deployment. Participant-Sharing, Provenance, interne IDs und Medien bleiben verboten. Privacy-/Legal-Approval, öffentlicher Consumer, real service-backed Recovery-E2E und Android-Parität fehlen. Keine Launch-/Acquisition-Aussage.                                                                                            |
| Place-Enrichment                                                                                                   | **Backend/Worker/Gateway/Mobile-Client plus nativer Zero-result-Review-Flow Current; Experience `[P-ENRICHMENT]`**                                                     | Engineering-Proof darf budgetierte asynchrone Jobs sowie Select, Status und Retry benennen. Der code- und test-current native Flow startet die länderbegrenzte weltweite Suche erst nach einem leeren lokalen Ergebnis, begrenzt automatische Statusabfragen auf drei, zeigt Feldquellen zur Prüfung, verlangt explizites Freigeben oder Ablehnen und verbindet einen freigegebenen Ort über den bestehenden Ortspfad. Keine Acquisition-Copy vor deploytem und überwachtem Provider-Betrieb, Produktion sowie Offline-/Device-E2E.                                                                                                                                                                                                                                                                                                                                                     |
| Product-Feedback                                                                                                   | **Backend/Gateway/Mobile-Client/SQLite + produktiv gerouteter Design-2-Code und lokale Experience Current; Release `[P-FEEDBACK]`**                                    | Aktive Owner und Organizer können eine Meldung online statussetzen oder mit einem bereinigten Same-root-Ziel zusammenführen; Rollen-, Root-, Idempotency- und Safe-refresh-Pfade sind code- und test-current. Das finale lokale Team-/Feedback-Paket belegt Capture, Preview, default-off Screenshot-Consent, dauerhafte Queue, genau eine Attachment-Zustellung, Server-Readback nach Cold Restart und Logout-Purge. Community-Writes bleiben online-only. Keine Acquisition-Copy vor physischen Geräten, Distributionssignatur, vollständiger Accessibility, HEIC-/Failure-Matrix, Native-to-Staging-E2E, Stores, Produktion und allgemeiner Launch-Freigabe.                                                                                                                                                                                                                         |
